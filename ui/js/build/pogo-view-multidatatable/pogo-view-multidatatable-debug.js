YUI.add('pogo-view-multidatatable', function(Y) {
...
}, '@VERSION@' ,{requires:['base','view','datatable','pogo-model-jobslist','tabview','pogo-formatters','gallery-paginator-dev-preview']});
